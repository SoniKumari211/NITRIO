...
public class Logout {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(3000);        
        driver.findElement(By.xpath("//*[@id='dashboard']/div/div[1]/div/nav/div[2]/a")).click();
        System.out.println("Click on Menu Icon...");
        driver.findElement(By.xpath("//*[@id='menu']/div/ul/li[5]/a")).click();
